        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div className="flex-1 leading-relaxed text-lg" style={{ color: 'var(--text-muted)' }}>
              ...
              <p>
                Through August 2026 I worked at <strong style={{ color: 'var(--text-main)' }}>SourceOne Ltd in Hong Kong</strong>, evaluating automated factories across China and supporting product validation for customers including Mainspring Energy, Toyota USA, and Rough Country. Now I&apos;m back in New York, finishing my M.S. in Technology Management at Columbia University.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 leading-relaxed text-lg" style={{ color: 'var(--text-muted)' }}>
            <p>
              My focus is <strong style={{ color: 'var(--text-main)' }}>technical product management for robotics, hardware, and AI-enabled physical products</strong>. The through-line in my work is the full chain from customer requirements to engineering decisions to manufacturing reality: FoldRide Pro from user needs to a filed patent and production files, a NASA Psyche capstone from constraints to tested prototype, and factory evaluations from customer specs to supplier decisions.
            </p>
